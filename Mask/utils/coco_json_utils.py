...
class CocoJsonCreator():
    def validate_and_process_args(self, args):
        ...
        self.dataset_config_path = args.dataset_config_path
    ...
    def main(self, args):
        ...
        #output_path = Path(self.dataset_dir) / f'{self.phase}_coco_instances.json'

        output_path = self.dataset_config_path + f'{self.phase}_coco_instances.json'
...
if __name__ == "__main__":
    ...
    parser.add_argument("-ph", "--phase", dest="phase",
        help="train for validation coco data set?")
    parser.add_argument("-dp", "--dataset_config_path", dest="dataset_config_path",
        help="Path where wer store the dataset configs for training on the blob")
