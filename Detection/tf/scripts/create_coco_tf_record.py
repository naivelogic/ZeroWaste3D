#https://github.com/ammarchalifah/people-counting/blob/master/object_detection/dataset_tools/create_coco_tf_record.py
...
TESTDEV_ANNOTATIONS_FILE=/mnt/omreast_users/phhale/csiro_trashnet/datasets/ds0v5/coco_ds/test_coco_instances.json
VAL_ANNOTATIONS_FILE=/mnt/omreast_users/phhale/csiro_trashnet/datasets/ds0v5/coco_ds/val_coco_instances.json
TRAIN_IMAGE_DIR=/mnt/omreast_users/phhale/csiro_trashnet/datasets/ds0v5/images
VAL_IMAGE_DIR=/mnt/omreast_users/phhale/csiro_trashnet/datasets/ds0v5/images
TEST_IMAGE_DIR=/mnt/omreast_users/phhale/csiro_trashnet/datasets/ds0v5/images
OUTPUT_DIR=/mnt/omreast_users/phhale/csiro_trashnet/datasets/ds0v5/tf_ds/
python create_coco_tf_record.py --logtostderr \
      --train_image_dir="${TRAIN_IMAGE_DIR}" \
      --val_image_dir="${VAL_IMAGE_DIR}" \
      --test_image_dir="${TEST_IMAGE_DIR}" \
