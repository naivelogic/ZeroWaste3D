# https://github.com/TannerGilbert/Tensorflow-Object-Detection-API-train-custom-Mask-R-CNN-model/blob/master/create_coco_tf_record.py
...
def main(_):
  ...
  testdev_output_path = os.path.join(FLAGS.output_dir, 'test.tfrecord')
