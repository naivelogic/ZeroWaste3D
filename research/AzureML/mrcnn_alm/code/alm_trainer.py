...
class x2_BaseConfig(Config):
    ...
    NUM_CLASSES = 1 + 5  # background + 5 (ds1)
    STEPS_PER_EPOCH = 171
    BATCH_SIZE=1
...
dataset_train.load_data(MASKS_PATHS + '/train_coco_instances.json', IMAGES_PATHS)
dataset_train.prepare()

dataset_val = CocoLikeDataset()
dataset_val.load_data(MASKS_PATHS + '/val_coco_instances.json', IMAGES_PATHS)
dataset_val.prepare()
